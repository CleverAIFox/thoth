...
**5.3초**(로컬 엔진은 80.7초), 45유닛 골든셋에서 위반 3유닛(용어 2 · 고유명사 1),
...
같은 조건에서 80.7초이고 콜드 로딩 87.6초가 더 붙는다. 위반은 호스팅 3유닛 ·

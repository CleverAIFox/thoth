...
| `bedrock` | Bedrock Converse · `nova-lite` | **배포본. 547자/초** |
...
**호스팅 실측은 문항 하나에 5.1초다**(45유닛 · 배치 3 · Nova Lite). 로컬은
같은 조건에서 80.7초이고 콜드 로딩 87.6초가 더 붙는다. 위반은 양쪽 다 3유닛이다.
...
- 남은 위반 4건은 용어 표기다. record · consumer 처럼 일반 번역어가 있는
  말에서 새며, 오정보가 아니다
